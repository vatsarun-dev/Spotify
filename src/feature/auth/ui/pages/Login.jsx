  ...
  },
  {
    ...
    icon: (
      <svg aria-hidden="true" viewBox="0 0 24 24" className="h-5 w-5">
        ...
        <path
          d="M13.37 19v-5.84h1.95l.3-2.28h-2.25V9.43c0-.66.18-1.11 1.12-1.11h1.2V6.28c-.58-.08-1.17-.12-1.75-.11-1.73 0-2.91 1.06-2.91 3v1.7H9.08v2.28h1.95V19h2.34Z"
          fill="#fff"
        />
      </svg>
    ),
        ...
        <section className="flex flex-1 items-start justify-center px-6 pb-12 pt-10 sm:px-8 sm:pt-14">
          <div className="w-full max-w-[734px] rounded-[28px] bg-[#121212]">
            <div className="mx-auto flex w-full max-w-[324px] flex-col items-center">
              ...
              <h1 className="text-center text-[2.65rem] font-black leading-[1.02] tracking-[-0.04em] sm:text-[3.35rem]">
                Welcome back
              </h1>
              ...
              <div className="mt-16 text-center">
                ...
                <a
                  ...
                  className="cursor-pointer mt-3 inline-block text-[18px] font-bold text-white underline decoration-white/55 underline-offset-4 transition hover:text-[#1ed760]"
                >
                  Sign up
                </a>
              </div>

              <p className="mt-16 max-w-[315px] text-center text-[12px] leading-5 text-white/45">
